...
export const createFhirMessageBundle = (
...
export const createFhirQuestionnaireResponse = (
  ...
  practioner: IReference,
  patient: IReference,
  items: IQuestionnaireResponse_Item[]
): IQuestionnaireResponse => {
  return {
...
export const createFhirBestilling = (data: fhirBestilling) => {
  ...
  const questionnaireResponse = createFhirQuestionnaireResponse(
    questionnaire,
    {
      type: 'Practitioner',
  ...
  return createFhirMessageBundle(
    [task, questionnaire, questionnaireResponse],
    saksbehandlerIdentifier
  );
};
...
export const createFhirReference = (resource: IResourceList) => {
  const reference: IReference = {
